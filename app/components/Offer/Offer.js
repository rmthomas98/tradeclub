      ...
      <div className={styles.container}>
          ...
          <div className={styles.infoContainer}>
            ...
            <Fade direction="up">
              <p className={styles.smallDescription}>
                ...
                the table to ensure you are surrounded by like-minded, sharp,
                and hungry individuals day in and day out, as well as having
                access to our team of professional traders and mentors during
                the trading day.
              </p>
            </Fade>
          </div>
        ...
        <div className={`${styles.flexContainer} ${styles.columnReverse}`}>
          <div className={styles.infoContainer}>
            ...
            <Fade cascade direction="left" damping={0.2} delay={400}>
              <div className={styles.itemContainer} style={{ marginTop: 20 }}>
                ...
                <p className={styles.smallestDescription}>
                  State of the Art High-Performance Trading PCs tailormade by
                  Dell
                </p>
              </div>
              <div className={styles.itemContainer}>
                <BsCheck style={{ marginRight: 5, minWidth: 20 }} />
                <p className={styles.smallestDescription}>
                  Multiple Monitor Displays (Dell 27” 165Hz Monitors offered in
                  2 or 3 screen configurations)
                </p>
              </div>
              <div className={styles.itemContainer}>
          ...
          <div className={styles.infoContainer}>
            ...
            <Fade direction="up">
              <p className={styles.smallDescription}>
                ...
                competition is lacking. That is why we made the focal point of
                our amenities aid in not only the strategy growth of every
                individual trader, but more importantly the improvement of their
                health, wellness, and mentality. As a member you will get access
                to:
              </p>
            </Fade>
            <Fade cascade direction="right" delay={400} damping={0.2}>
              <div className={styles.itemContainer} style={{ marginTop: 20 }}>
                <BsCheck style={{ marginRight: 5, minWidth: 20 }} />
                <p className={styles.smallestDescription}>
